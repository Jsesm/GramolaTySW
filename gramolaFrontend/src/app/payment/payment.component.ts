...
export class PaymentComponent implements OnInit { 
  stripe?: any;
  mensaje?: string= "Ya casi lo tenemos, completa el pago para tener acceso a todos los servicios de Gramola";
        ...
        if (response.paymentIntent.status === 'succeeded') { 
          ...
          self.paymentService.confirm(response, self.transactionDetails.id, self.token!).subscribe({ 
            next: (response: any) => { 
              ...
              self.mensaje="PAGO REALIZADO CON ÉXITO... Se te redirigirá a la pantalla de inicio de sesión."
