...
public class TestPonerCancion {
        ...
        public static void main(String[] args) throws InterruptedException {
                ...
                int cancionesAntes = contarCanciones();
                ...
                campoTarjeta.sendKeys("4242424242424242 2356 567");
                ...
                wait.until(ExpectedConditions.invisibilityOfElementLocated(
                                By.xpath("/html/body/app-root/app-music-user/div[2]/div")));

                Thread.sleep(3000);

                int cancionesAhora = contarCanciones();

                System.out.println("\n\n\n\n--- RESULTADO DEL TEST ---");
                System.out.println("Canciones al inicio: " + cancionesAntes);
                System.out.println("Canciones al final: " + cancionesAhora);

                assertEquals(cancionesAntes + 1, cancionesAhora, "La base de datos no aumentó en 1");

                System.out.println("Se ha incluido la canción correctamente!");

        }

        public static int contarCanciones() {
                int total = 0;
                String query = "SELECT COUNT(*) AS total FROM cancion";
